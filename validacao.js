...
export const modeloTime =  Joi.object({
    ...
    pontos: Joi.number().default(0).min(0),
    vitorias: Joi.number().default(0).min(0),
    empates: Joi.number().default(0).min(0),
    derrotas: Joi.number().default(0).min(0),
    golsMarcados: Joi.number().default(0).min(0),
    golsSofridos: Joi.number().default(0).min(0),
    saldoGols: Joi.number().default(0).min(0),
  });
